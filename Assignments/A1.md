...
# Part 1 (L1.1, 1.2)
For your tent, follow the in class steps and submit documentation of:

1. What [systems] does it have?
2. What features does it have? [M1]
3. growth stages [M2]
4. Functions (Biomimetics) [M3]
6. Documenting your weeks activities, features and functions.

<!-- Week 2 Activity 1 for tent and Week 3 Activity 1 for building-->

# Part 2 (L1.1)
Follow the in class steps and submit for the *building*:

1. What [systems] does the building have?
     * Analyse existing building models of building 308
3. What are the features of these systems [M1]
   * Identify needs of the building and its requirements 
5. Select a specific system can you define its growth stages? [M2]
6. Can you identify some biological systems that have the same function? (Biomimetics) [M3]
7. Its identified needs.
9. Consider how can the defined issues and defined functions of a building meet the building needs from a systems perspective?
10. Define a set of requirements a building needs to meets its defined functions
11. Documenting all weeks activities, features and functions.
<!-- 2025 A2 to add for 2027 A1: . What stages could you imagine your system going through to satisfy the needs you identified in the previous assignment? 
...
1. On campus, identify three examples of that thing that you feel represent three steps in the evolutional history of that system
2. Identify the phenotypic plasticity of these systems – your agile prototypes 
3. Identify the ‘evolutionary history’ of your agile prototypes -->
...
[M1]: /Methodology/01.md
[M2]: /Methodology/02.md
[M3]: /Methodology/03.md
[M4]: /Methodology/04.md
[Gene]: /Agile/Genes
