...
|          |  Experiment  |
|----      |-----|
|  Aim     | To design and collaborate within your groups and systems  |
| Tools    | Pen and paper / computational design | 
| Case     | Building |
| Groups   | Same group of 4 |
| Practice | In class activity in week 10,11,12 |
| Learning objectives | 4.1, 4.2, 4.3, 4.4 | 
...
## Assignment Details
## Part 1: Model and Build the prototype** (L4.1, L4.2)
* Experiment and Evaluate
  
## Part 2: Prove the prototype (L4.3)
* Test it - (does it work really)

### Presentation   <br />
* Present it (did it work, prove it - how to do it better)
* Make a 3 min pre-recorded video that will be shared in class
 

### Part 3: Individual Reflection   (L4.4)

Write a short individual reflection on the agile prototyping methodology and multidisciplinary teamwork

Submitted on DTU Learn by Sunday November 29,2026.
