...
## Part 1  (L2.2)
* Analyse proposed building of 308 existing and proposed reports, and their floor plans
   * [B308 Existing Reports](https://learn.inside.dtu.dk/d2l/le/lessons/326237/lessons/1274240)
   * [B308 Floor Plans](https://learn.inside.dtu.dk/d2l/le/lessons/326237/topics/1279830)
   * [B308 Proposed Reports](https://learn.inside.dtu.dk/d2l/le/lessons/326237/lessons/1279349)
* Analysis of existing systems and element types list from excel activity in Week 4
* Boxbuild in class activity in Week 5
  * SVG of the Boxbuild grid floors and a short descriptive text of explaining your process and choices.
* Identify issues and gaps with current proposed approaches in class activity in Week 5
* Building constraints in Week 6
* Tracing elements in all design proposals from system perspective in Week 6

<!-- to be used in A3
## Part 2 (L2.1)

* Sequencing - goal of a universal sequence for each system and plasticity considerations
* The sequence and systems universal sequence as done in activities in Week 6
