...
> 2.1 Model and traverse a phylogenetic tree of the features of AP to identify new solutions. ( Plasticity/ Evolutionary tree of how to get from existing to proposed buildings from a systems perspective, as each system evolves differently) 
...
<!-- Week 4: Types: Review data and classify building element & types and excel sheet

**Output: Excel**

Week 5: System Input data into boxbuild from systems and map it, 
  * Lecture from slides from week 1 ( eg parametric paradox) + slides from ABIM about boxbuild
  * BOXBuild (and download svg file of your box build)
  * Identify design issues ( Charlie)

**Output: Boxbuild - simple representation of existing and 7 proposed floor plans from a systems perspective, SVG of the floors and discuss**

Week 6: Plasticity and Sequencing
  * Lecture: sequencing and biological influence ( stain elements, mutations, and phenotypic plasticity) - 20 min
  * Identify the constraints/ plasticity limits of the current design systems
  * How do the different constraints limit the design into the proposed solutions
  * Go through the 7 projects and find one element that has not changed from a systems perspective? Could it change? Is it fixed? What are the implications of the change? ( Managers to ensure there are different elements being studied) 
 ...
 **Output: Sequencing - goal of a universal sequence for each system and plasticity considerations**

**Put in weeks thats this activity  to A2**
Week 7: How to use CURE Framework to unlock all those constraints to make it more agile -->


## Part 1 (L2.1)

<!-- 2025 MOVE TO A1 AS A COMMENT AND SAY ADD IN. What stages could you imagine your system going through to satisfy the needs you identified in the previous assignment? 
